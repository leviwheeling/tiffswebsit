...
# Import the ping service
from ping_service import start_ping_service, stop_ping_service, get_ping_stats
...
@app.get("/ping-stats", include_in_schema=False)
async def ping_stats():
    """Return current ping service statistics."""
